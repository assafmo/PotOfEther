...
const contractAddress = '0xa9c947b1ad8d9cc08eb5ba27250e24e907831b8b';
...
const AccountInfoPanel = React.createClass({
    getInitialState: () => ({
        pots: []
    }),
    componentDidMount: function () {
        const watcher = potOfEther.LogPotJoined(null)//, { fromBlock: 0 });
        /*{ newPlayer: web3.eth.defaultAccount }*/
...
const a = potOfEther.createPot("papaya" + Date.now(), { value: 1054535400, gas: 2000000 })
console.log(a);